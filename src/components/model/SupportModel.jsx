              ...
              <div className="flex gap-3">
                ...
                <div className="flex-col">
                  <p className="text-[15px]">
                    It seems we couldn't find the information you were looking
                    for regarding "{userQuestion}". Would you like to escalate
                    this to the respective team and continue the conversation
                    with a human representative? If yes, please raise a support
                    ticket below, and our team will assist you promptly.
                  </p>

...
const ReimbursementModal = ({ isOpen, setIsOpen }) => {
  ...
  const handleSubmit = () => {
    const reimbursementData = { expenseType, expenseDate, expenseAmount, description, modeOfPayment };
    console.log('Submitted Reimbursement:', reimbursementData);
        ...
        >
          ...
          >
            ...
            <div className='p-4'>
              ...
              {/* Expense Amount */}
              <div className='mb-3'>
                <label className='block text-gray-400 text-sm mb-1'>Expense Amount (USD)</label>
                <input
                  type='number'
                  value={expenseAmount}
